...
import com.zgld.mall.adapter.CustomerOrdersAdapter;
...
public class CustomerOrders1Fragment extends BuyersOrdersBaseFragment implements OnRefreshListener2,
        OnItemClickListener, OnClickListener ,CustomerOrdersAdapter.CustomerOrdersAdapterListener {
    List<Orders> listInfo = new ArrayList<Orders>();
    PullToRefreshExpandableListView listview;
    CustomerOrdersAdapter infoAdapter;
    View view;
    Activity activity;
            ...
            switch (msg.what) {
                case 202:
                    if (pageNum == 1) {
                        ...
                        infoAdapter = new CustomerOrdersAdapter(activity,activity, listInfo,this);
