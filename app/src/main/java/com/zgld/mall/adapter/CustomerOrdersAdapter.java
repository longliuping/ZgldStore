...
public interface CustomerOrdersAdapterListener{
	...
	CustomerOrdersAdapterListener listener;
	Activity activity;
	public CustomerOrdersAdapter(Activity activity, Context context, List<Orders> listInfo, CustomerOrdersAdapterListener listener) {
