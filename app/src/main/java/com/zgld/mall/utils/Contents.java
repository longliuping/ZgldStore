...
//    public static final String BASE_URL = "http://192.168.1.152:8080/ZgldStoreApi/json/";
    public static final String BASE_IMAGE_PATH = "http://115.28.20.167/";
    public static final String PAGESIZE = "pageSize";//每一页的数据量
    public static final String PAGENUM = "pageNum";//当前页
    public static final String TOKEN = "token";//用户TOKEN
    public static final String USERID = "userId";//用户ID
    public static final String SHOPID = "shopId";//商家ID
    public static final String DATA = "data";
    public static final String INFO = "info";
    public static final String GSON_OBJECT = "gson_object";
    public static final String LISTINIFO = "listInfo";
    public static final String MSG = "msg";
    public static final String STATUS = "status";//状态吗
