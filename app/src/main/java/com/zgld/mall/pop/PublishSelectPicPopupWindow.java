...
//	List<HishopSkuitems> listHishopSkuitems = new ArrayList<>();
	...
	public PublishSelectPicPopupWindow(final Activity context, YShop info,
...
//		}
	...
	public Sku getSkus(String skuId){
		Sku skus = null;
		for (int i=0;i<listHishopSkus.size();i++){
			if(listHishopSkus.get(i).getSku().equals(skuId)){
